...
const categories: Cat[] = [
    { id: 1, label: "Elettrodomestici", imageUrl: "/images/elettrodomestici.jpg" },
    { id: 2, label: "Elettronica", imageUrl: "/images/elettronica.jpg" },
    { id: 3, label: "Abbigliamento Sportivo", imageUrl: "/images/sportivo.jpg" },
    { id: 4, label: "Libri", imageUrl: "/images/libri.jpg" },
    { id: 5, label: "Mobili", imageUrl: "/images/mobili.jpg" },
    { id: 6, label: "Orologi", imageUrl: "/images/orologio.jpg" },
    { id: 7, label: "Accessori Moda", imageUrl: "/images/moda.jpg" },
    { id: 8, label: "Giochi da Tavolo", imageUrl: "/images/giochi.jpg" },
    { id: 9, label: "Sport e Attività all'Aperto", imageUrl: "/images/outdoors.jpg" },
    { id: 10, label: "Casa e Cura Personale", imageUrl: "/images/personalCare.jpg" },
    { id: 11, label: "Arredamento Interno", imageUrl: "/images/interiorDesign.jpg" },
    { id: 12, label: "Strumenti Musicali", imageUrl: "/images/music.jpg" }
];
